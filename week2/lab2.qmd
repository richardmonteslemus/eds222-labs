...
storm_data <- read_csv("week2/la_storm.csv")
...
beta0 hat and beta1 hat and beta0 and beta1 are basically the same

beta0: estimates gage height when no precipitation

beta1: for every inch of rain, the increase in gage height

sigma: Can be plus of minus this amount from the mean.
